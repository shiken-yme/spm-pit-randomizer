...
namespace mod
{
    ...
    ELSE()
    USER_FUNC(evt_msg::evt_msg_print_add_insert, 1, PTR(disorderIndifferenceItemNotif2), 0, 0, LW(9), LW(10))
    END_IF()
    END_IF()
    RETURN()
    EVT_END()
    ...
    USER_FUNC(evt_item::evt_item_flag_onoff, 0, PTR("IN1"), 0x800)
    ...
    USER_FUNC(evt_item::evt_item_flag_onoff, 0, PTR("IN2"), 0x800)
    ...
    USER_FUNC(evt_item::evt_item_flag_onoff, 0, PTR("IN3"), 0x800)
    ...
    USER_FUNC(evt_item::evt_item_flag_onoff, 0, PTR("IN4"), 0x800)
