...
EVT_DECLARE_USER_FUNC(evt_snd_player_fadeout, 2)
EVT_DECLARE_USER_FUNC(evt_snd_player_fadein, 2)
UNKNOWN_FUNCTION(func_800d231c)
UNKNOWN_FUNCTION(func_800d2388)
EVT_DECLARE_USER_FUNC(evt_snd_bgm_set_vol, 3)
...
// evt_snd_get_bgm_name(s32 bgmPlayerId, const char * ret)
EVT_DECLARE_USER_FUNC(evt_snd_get_bgm_name, 2)
